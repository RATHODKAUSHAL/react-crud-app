                                        ...
                                        <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_Redesign_feedback_re_jvm0.png" className="custom-block-image img-fluid" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-12">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/colleagues-working-cozy-office-medium-shot.png" className="custom-block-image img-fluid" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                                <div className="custom-block bg-white shadow-lg">
                                                    <a href="/topic-details">
                                                        ...
                                                        <img src="src/assets/images/topics/undraw_online_ad_re_ol62.png" className="custom-block-image img-fluid" alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                                <div className="custom-block bg-white shadow-lg">
                                                    <a href="/topic-details">
                                                        ...
                                                        <img src="src/assets/images/topics/undraw_Group_video_re_btu7.png" className="custom-block-image img-fluid" alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-4 col-md-6 col-12">
                                                <div className="custom-block bg-white shadow-lg">
                                                    <a href="/topic-details">
                                                        ...
                                                        <img src="src/assets/images/topics/undraw_viral_tweet_gndb.png" className="custom-block-image img-fluid" alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-12 mb-4 mb-lg-0">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_Finance_re_gnv2.png" className="custom-block-image img-fluid" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <div className="d-flex flex-column h-100">
                                                    ...
                                                    <div className="custom-block-overlay-text d-flex">
                                                        <div>
                                                            ...
                                                            <a href="/topic-details" className="btn custom-btn mt-2 mt-lg-3">Learn More</a>
                                                        </div>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_Compose_music_re_wpiw.png" className="custom-block-image img-fluid" alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_happy_music_g6wc.png" className="custom-block-image img-fluid" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-12">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_Podcast_audience_re_4i5q.png" className="custom-block-image img-fluid" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-12 mb-4 mb-lg-3">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_Graduation_re_gthn.png" className="custom-block-image img-fluid" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-12">
                                            <div className="custom-block bg-white shadow-lg">
                                                <a href="/topic-details">
                                                    ...
                                                    <img src="src/assets/images/topics/undraw_Educator_re_ju47.png" className="custom-block-image img-fluid" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
